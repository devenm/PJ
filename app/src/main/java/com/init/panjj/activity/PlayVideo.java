...
import com.init.panjj.adapter.CommentAdap;
import com.init.panjj.adapter.SimilerAdopter;
import com.init.panjj.otherclasses.DatabaseHandler;
...
post.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View v) {
        ...
        switch (BackgroundProcess.shared.getInt("type", 0)){
            case 0:
...
RadioButton radioButton= (RadioButton) dialog.findViewById(BackgroundProcess.shared.getInt("posi", R.id.p200));
