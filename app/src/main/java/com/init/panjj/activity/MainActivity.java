...
import com.init.panjj.fragments.Movies_mainPage;
import com.init.panjj.fragments.Trailers_tab;
import com.init.panjj.fragments.Video_tab;
...
public class MainActivity extends AppCompatActivity implements FragmentDrawer.FragmentDrawerListener {
    ...
    SharedPreferences sharedPreferences = BackgroundProcess.shared;
    ...
    public void dialogshow(DialogFragment newFragment, String url, String song, String vd, String tag, int i, String name) {
        ...
        bundle.putString(ShareConstants.WEB_DIALOG_PARAM_NAME, name);
        bundle.putInt("pos", i);
        newFragment.setArguments(bundle);
        newFragment.show(ftt, "dialog");
    }
