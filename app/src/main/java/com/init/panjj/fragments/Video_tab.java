...
public class Video_tab extends Fragment implements ServerResult, Communicator, SwipeRefreshLayout.OnRefreshListener {
    MainActivity act;
    ...
    private void videoRequest() {
        ...
        new ServerRequest(this, "http://iiscandy.com/panj/SectionVTPlayList?id=2&" + "&stype=" + dtype, new HashMap(), 3, 0);
    }
