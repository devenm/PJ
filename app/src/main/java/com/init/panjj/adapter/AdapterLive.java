...
import com.init.panjj.activity.LiveStreamPlay;
...
public class AdapterLive extends RecyclerView.Adapter<AdapterLive.MyViewHolder> {
    ...
    Activity act;
    Bitmap bitmap;
    public AdapterLive(Activity act,ArrayList<LiveTvBean> list) {
        this.list=list;
        this.act=act;
    }
    ...
    public void onBindViewHolder(final MyViewHolder myViewHolder, final int position) {
        if (list.size() > 0) {
            final LiveTvBean liveTvBean=list.get(position);
            myViewHolder.title.setText(""+liveTvBean.getTvname());
            ImageLoader.getInstance().loadImage(liveTvBean.getTvimage(), new SimpleImageLoadingListener() {
                @Override
            ...
            myViewHolder.imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("url", liveTvBean.getTvname());
