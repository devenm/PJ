 ...
 */
public class AllInOnAdapter extends RecyclerView.Adapter<AllInOnAdapter.MyViewHolder> {
    ...
    public AllInOnAdapter(Activity activity, ArrayList<ItemBean> mainlist) {
